...
-   `$testcd`: Creates a table for each `STUDYID` and `TESTCD` (code for a specific test/finding) with the min, max and various quantiles for numeric results, and the number of unique units, locations, methods and specimens.
