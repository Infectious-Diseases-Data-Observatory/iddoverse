...
Source:
[`inst/CITATION`](https://github.com/Infectious-Diseases-Data-Observatory/iddoverse/blob/HEAD/inst/CITATION)
...
data to analyse datasets', Infectious Disease Data Observatory,
